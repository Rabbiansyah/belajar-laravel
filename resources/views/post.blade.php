<x-layout>
    ...
    <div class="mb-8">
        ...
        <div class="mb-8 rounded-lg overflow-hidden">
            <img src="{{  asset($post->img_url) }}" alt="Post Image" class="w-full h-auto">
        </div>
    </div>
    ...
    <div class="mt-8 flex flex-wrap">
        ...
        <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm mr-2 mb-2">Esports</span>
    </div>
