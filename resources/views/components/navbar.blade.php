                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button @click="isOpen = !isOpen" id="user-menu-button" type="button"
                                    ...
                                    <img src="{{ asset('rei.jpg') }}" alt="" class="size-8 rounded-full" />
                                </button>
                            </div>
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="text-sm font-medium text-gray-400">Rei@example.com</div>
                    </div>
                    <button type="button"
