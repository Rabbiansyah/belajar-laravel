            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button @click="isOpen = !isOpen" type="button" aria-controls="mobile-menu" aria-expanded="false"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                        aria-hidden="true" class="block size-6" :class="{ 'hidden': isOpen, 'block': !isOpen }">
                        <path d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                    <!-- Menu open: "block", Menu closed: "hidden" -->
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                        aria-hidden="true" class="hidden size-6" :class="{ 'hidden': !isOpen, 'block': isOpen }">
    ...
    <div x-show="isOpen" id="mobile-menu" class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Althafiyawan</div>
                    <div class="text-sm font-medium text-gray-400">Althafiyawan99@gmail.com</div>
                </div>
                <button type="button"
